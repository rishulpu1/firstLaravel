    ...
    <div class="container py-md-5 container--narrow">
          <form action="/post/{{$post->id}}" method="POST">
            ...
            <div class="form-group">
              ...
              <input required name="title" id="post-title" class="form-control form-control-lg form-control-title" value="{{old('title', $post->title)}}" type="text" placeholder="" autocomplete="off" />
              @error('title')
